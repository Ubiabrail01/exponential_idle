...
var init = () => {
    ...
    // b1
    {
        ...
        b1 = theory.createUpgrade(0, currency, new ExponentialCost(2, Math.log2(1.2)));
    ...
    // c1
    {
        ...
        c1 = theory.createUpgrade(1, currency, new ExponentialCost(3, Math.log2(1.6)));
    ...
    // c2
    {
        ...
        c2 = theory.createUpgrade(2, currency, new ExponentialCost(6, Math.log2(16)));
    ...
    // c3
    {
        ...
        c3 = theory.createUpgrade(3, currency, new ExponentialCost(1e20, Math.log2(96)));
    ...
    // c4
    {
        ...
        c4 = theory.createUpgrade(4, currency, new ExponentialCost(1e30, 32));
        c4.maxLevel = 32;
    ...
    // b2
    {
        ...
        b2 = theory.createUpgrade(10, currency2, new ExponentialCost(2, Math.log2(1.6)));
    ...
    // n1
    {
        ...
        n1 = theory.createUpgrade(11, currency2, new ExponentialCost(3, Math.log2(1.6)));
    ...
    // n2
    {
        ...
        n2 = theory.createUpgrade(12, currency2, new ExponentialCost(6, Math.log2(800)));
    ...
    // c5
    {
        ...
        c5 = theory.createUpgrade(13, currency2, new ExponentialCost(1e3, Math.log2(8e5)));
    ...
    // c6
    {
        ...
        c6 = theory.createUpgrade(14, currency2, new ExponentialCost(1e8, Math.log2(8e11)));
    ...
    // c7
    {
        ...
        c7 = theory.createUpgrade(15, currency2, new ExponentialCost(1e8, Math.log2(8e23)));
    ...
    // c8
    {
        ...
        c8 = theory.createUpgrade(16, currency2, new ExponentialCost(1e16, Math.log2(8e47)));
    ...
    // b3
    {
        ...
        b3 = theory.createUpgrade(30, currency3, new ExponentialCost(12, Math.log2(1.5)));
    ...
    // n3
    {
        ...
        n3 = theory.createUpgrade(31, currency3, new ExponentialCost(25, Math.log2(1.5)));
    ...
    // n4
    {
        ...
        n4 = theory.createUpgrade(32, currency3, new ExponentialCost(40, Math.log2(800)));
    ...
    // c9
    {
        ...
        c9 = theory.createUpgrade(33, currency3, new ExponentialCost(1e6, Math.log2(8)));
    ...
    // c10
    {
        ...
        c10 = theory.createUpgrade(34, currency3, new ExponentialCost(1e9, Math.log2(20)));
    ...
    // c11
    {
        ...
        c11 = theory.createUpgrade(35, currency3, new ExponentialCost(1e24, Math.log2(80)));
    ...
    // c12
    {
        ...
        c12 = theory.createUpgrade(36, currency3, new ExponentialCost(1e25, Math.log2(800)));
    ...
    // d4
    {
        ...
        d4 = theory.createUpgrade(40, currency3, new ExponentialCost(1e3, 0.8));
    ...
    // d6
    {
        ...
        d6 = theory.createUpgrade(41, currency3, new ExponentialCost(3e4, 1.5));
    ...
    // d8
    {
        ...
        d8 = theory.createUpgrade(42, currency3, new ExponentialCost(1e6, 2.4));
    ...
    // d10
    {
        ...
        d10 = theory.createUpgrade(43, currency3, new ExponentialCost(1e9, 3.2));
    ...
    // d12
    {
        ...
        d12 = theory.createUpgrade(44, currency3, new ExponentialCost(1e12, 4));
    ...
    // d20
    {
        ...
        d20 = theory.createUpgrade(45, currency3, new ExponentialCost(1e16,4.8));
    ...
    permAll = theory.createBuyAllUpgrade(1, currency, 1e10);
...
var getPublicationMultiplier = (tau) => {
    let mul = BigNumber.E.pow((tau + 1).log().pow(.750)) / 500 * getSkillEffect(5);
...
var getPublicationMultiplierFormula = (symbol) => {
    ...
    if (qTerms3.level > 0) mul *= getPerm7(perm7.level);
    return "\\frac{e^{\\ln(" + symbol + " + 1)^{0.750}}}{500}" + (mul > 1 ? "\\times" + mul.toString(0) : "");
}
